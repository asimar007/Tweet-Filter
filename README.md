...
Twitter can be overwhelming — politics, hate speech, war news, and controversy flood your feed every day. ZenX quietly filters that noise out, giving you back a cleaner, calmer timeline without you having to mute hundreds of accounts or keywords manually.
...
| ✏️ **Custom Keywords** | Add your own words/phrases to block |

| 📊 **Live Stats** | See exactly how many tweets were filtered vs. allowed |

| 🔄 **Real-time Sync** | Settings sync across all your devices via Chrome Sync |

| 👁️ **Peek Mode** | Unhide any filtered tweet with a single click |

| 🌙 **Dark Mode** | Adapts to X's light, dark, and dim themes |

| 🧩 **Onboarding Wizard** | Clean first-run setup — pick your filters and go |
...
> ZenX is not yet listed on the Chrome Web Store. Follow the steps below to install it directly from source in under 2 minutes.
...
This creates a `.output/chrome-mv3/` directory — that's your extension.
...
1. Click the **ZenX icon** in your browser toolbar (pin it for easy access)
